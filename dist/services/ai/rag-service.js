...
exports.getRegulationContextString = getRegulationContextString;
exports.getRegulationContext = getRegulationContext;
 ...
 */
async function getRegulationContextString(query, regulationType, topK = 5) {
    try {
        if (!pinecone) {
 ...
 */
async function getRegulationContext(query, regulationType, topK = 5) {
    try {
        if (!pinecone) {
            throw new Error('Pinecone client not initialized - missing PINECONE_API_KEY');
        }

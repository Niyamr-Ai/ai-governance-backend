...
const evidence_field_mapper_1 = require("./evidence-field-mapper");
 ...
 */
async function analyzeDocument(documentText, evidenceKey) {
    console.log(`\n${'='.repeat(80)}`);
    ...
    const mapping = (0, evidence_field_mapper_1.getEvidenceFieldMapping)(evidenceKey);
    if (!mapping) {
 ...
 */
function getFieldDescriptions(mapping) {
    const descriptions = {
        // Governance fields
...
//# sourceMappingURL=universal-document-analyzer.js.map
...
exports.generateShadowAIAssessment = generateShadowAIAssessment;
exports.suggestSystemLinks = suggestSystemLinks;
exports.prioritizeDiscoveredSystems = prioritizeDiscoveredSystems;
...
function buildPlatformDiscoveryQuery(asset) {
...
function buildRegulationQuery(asset, regulationType) {
 ...
 */
async function generateShadowAIAssessment(asset, userId, organizationContext) {
    ...
    try {
        ...
        5, undefined, // No specific system ID for discovery
        'discovery');
    ...
    try {
        ...
        platformContext = await (0, platform_rag_service_1.getPlatformContextString)(platformQuery, 5, 'discovery');
 ...
 */
async function suggestSystemLinks(asset, userId, maxSuggestions = 5) {
    ...
    try {
        ...
        const systemContext = await (0, user_system_rag_service_1.getUserSystemContextString)(linkQuery, userId, // TEMPORARY: using userId as orgId during transition
 ...
 */
async function prioritizeDiscoveredSystems(assets, userId) {
    ...
    try {
        ...
        const platformContext = await (0, platform_rag_service_1.getPlatformContextString)('shadow AI prioritization risk assessment business impact discovery management', 5, 'discovery');
 ...
 */
function createBasicAssessment(asset) {
...
//# sourceMappingURL=smart-shadow-ai-discovery.js.map
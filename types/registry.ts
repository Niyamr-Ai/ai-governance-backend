// TypeScript interfaces for AI System Registry
...
export interface AISystemRegistry {
  system_id?: string; // Supabase primary key
  id?: string; // fallback for legacy clients
  ...
  last_audit_date?: string | null; // ISO date string

...
exports.getGovernanceSuggestions = getGovernanceSuggestions;
...
async function getGovernanceSuggestions(req, res) {
    try {
        ...
        const suggestions = await (0, smart_governance_suggestions_1.generateSmartGovernanceSuggestions)(context, userId, Math.min(Math.max(1, maxSuggestions), 12) // Limit between 1-12
        );
        return res.json({
            suggestions,
            context: {
...
async function analyzeCompletionImpact(req, res) {
    try {
        ...
        const impact = await (0, smart_governance_suggestions_1.analyzeTaskCompletionImpact)(completedTaskTitle, context, userId);
        return res.json({
...
async function updateGovernanceTask(req, res) {
    try {
        ...
        void (0, governance_tasks_1.evaluateGovernanceTasks)(updatedTask.ai_system_id);
...
async function getContextualHelp(req, res) {
    try {
        ...
        const help = await (0, smart_governance_suggestions_1.getTaskContextualHelp)(taskTitle, taskDescription || "", context, userId);
        return res.json({

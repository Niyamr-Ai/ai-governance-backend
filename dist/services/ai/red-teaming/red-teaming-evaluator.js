 ...
 */
function evaluateResponse(attackType, attackPrompt, systemResponse) {
 ...
 */
function detectInstructionLeakage(response) {
 ...
 */
function detectUnsafeContent(response, attackType) {
 ...
 */
function detectGuardrailBypass(response, attackType) {
 ...
 * Detect data leakage
 */
function detectDataLeakage(response, attackType) {
 ...
 */
function getRiskLevelForUnsafeContent(attackType) {
    switch (attackType) {
        case 'policy_bypass':
            return 'HIGH';
        case 'jailbreak':
...
//# sourceMappingURL=red-teaming-evaluator.js.map
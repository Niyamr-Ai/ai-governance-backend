...
exports.analyzeGovernanceDocument = analyzeGovernanceDocument;
 ...
 */
async function analyzeGovernanceDocument(documentText, formType = 'MAS') {
    console.log(`\n${'='.repeat(80)}`);
...
//# sourceMappingURL=governance-document-analyzer.js.map
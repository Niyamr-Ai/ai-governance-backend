...
exports.submitRiskAssessment = submitRiskAssessment;
exports.approveRiskAssessment = approveRiskAssessment;
exports.rejectRiskAssessment = rejectRiskAssessment;
exports.updateMitigationStatus = updateMitigationStatus;
 ...
 */
async function submitRiskAssessment(req, res) {
    try {
 ...
 */
async function approveRiskAssessment(req, res) {
    try {
        const userId = req.user.sub;
        const { id: assessmentId } = req.params;
        const body = req.body || {};
        ...
        const { shouldBlockComplianceApproval } = await Promise.resolve().then(() => __importStar(require("../../services/compliance/shadow-ai-governance")));
        ...
        await (0, governance_tasks_1.evaluateGovernanceTasks)(updatedAssessment.ai_system_id);
        // Auto-regenerate documentation when risk assessment is approved (non-blocking)
        // Don't await - let it run in background
        void (async () => {
            try {
                const { autoRegenerateDocumentationOnRiskApproval } = await Promise.resolve().then(() => __importStar(require("../../services/documentation/documentation-auto-generate")));
 ...
 */
async function rejectRiskAssessment(req, res) {
    try {
        const userId = req.user.sub;
        const { id: assessmentId } = req.params;
        const body = req.body || {};
 ...
 */
async function updateMitigationStatus(req, res) {
    try {
        const userId = req.user.sub;
        const { id: assessmentId } = req.params;
        const body = req.body;
 ...
 */
async function getRiskAssessmentById(req, res) {
    try {
        const userId = req.user.sub;
        const { id: assessmentId } = req.params;
        const supabase = supabase_1.supabaseAdmin;
 ...
 */
async function updateRiskAssessment(req, res) {
    try {
        const userId = req.user.sub;
        const { id: assessmentId } = req.params;
        const body = req.body;
        ...
        if (euSystem) {
            ...
            if (!(0, lifecycle_governance_rules_1.canEditRiskAssessment)(lifecycleStage, fullAssessment.status)) {
        ...
        if (body.risk_level !== undefined)
            updateData.risk_level = body.risk_level;
        if (body.mitigation_status !== undefined)
            updateData.mitigation_status = body.mitigation_status;
        if (body.evidence_links !== undefined)
            updateData.evidence_links = body.evidence_links;
 ...
 */
async function deleteRiskAssessment(req, res) {
    try {
        const userId = req.user.sub;
        const { id: assessmentId } = req.params;
        const supabase = supabase_1.supabaseAdmin;
...
//# sourceMappingURL=risk-assessments.controller.js.map
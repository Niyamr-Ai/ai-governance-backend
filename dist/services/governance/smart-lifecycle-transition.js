...
exports.assessTransitionReadiness = assessTransitionReadiness;
exports.generateTransitionPlan = generateTransitionPlan;
exports.suggestBlockerResolutions = suggestBlockerResolutions;
...
function buildTransitionReadinessQuery(systemData, currentStage, targetStage) {
...
function buildRegulationTransitionQuery(currentStage, targetStage, regulationType) {
...
function buildPlatformTransitionQuery(currentStage, targetStage) {
 ...
 */
async function assessTransitionReadiness(systemData, targetStage, userId) {
    ...
    try {
        ...
        platformContext = await (0, platform_rag_service_1.getPlatformContextString)(platformQuery, 5, 'lifecycle');
 ...
 */
async function generateTransitionPlan(systemData, fromStage, toStage, readinessAssessment, userId) {
    ...
    try {
        ...
        const platformContext = await (0, platform_rag_service_1.getPlatformContextString)(`lifecycle transition planning ${fromStage} ${toStage} project management implementation strategy AI systems governance`, 5, 'lifecycle');
 ...
 */
async function suggestBlockerResolutions(blockers, systemContext, userId) {
    ...
    for (const [index, blocker] of blockers.entries()) {
        try {
            ...
            try {
                ...
                platformContext = await (0, platform_rag_service_1.getPlatformContextString)(platformQuery, 3, 'lifecycle');
                if (platformContext === "No relevant platform knowledge found.")
                    platformContext = '';
            }
            catch (error) {
            ...
            if (blocker.blocker_type === 'regulatory') {
                try {
                    ...
                    regulationContext = await (0, rag_service_1.getRegulationContextString)(regulationQuery, regulationType, 3);
                    if (regulationContext === "No relevant context found.")
                        regulationContext = '';
                }
                catch (error) {
...
//# sourceMappingURL=smart-lifecycle-transition.js.map
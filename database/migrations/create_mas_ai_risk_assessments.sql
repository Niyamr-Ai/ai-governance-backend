-- Create MAS AI Risk Assessments table
-- This table stores assessments based on MAS (Monetary Authority of Singapore) AI Risk Management Guidelines
CREATE TABLE IF NOT EXISTS mas_ai_risk_assessments (
  ...
  -- Each pillar has: status, score, gaps, recommendations
  -- Note: Column names are quoted to preserve camelCase for Supabase/PostgREST
